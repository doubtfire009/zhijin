        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6" style="margin-top: 60px;">
              <form class="form-horizontal" role="form" action="<?php echo base_url('index.php/member/Zj_user/register_do'); ?>" method="post">
                  <input type="hidden"  id="location_flag" name="location_flag" value="email" >
    <div class="form-group" >
      <label for="user_account" class="col-sm-2 control-label">邮箱</label>
      <div class="col-sm-6">
          <input type="text" class="form-control" id="user_account"  name="user_account"
            placeholder="请输入邮箱" value="<?php echo set_value('user_account'); ?>">
         <a href="<?php echo base_url('index.php/member/Zj_user/register_mobile');?>" class="sm_font">使用手机注册</a>
      </div>
       <div class="col-sm-4">
